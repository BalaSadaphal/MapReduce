...
public class ProductReviewCountMapper extends
	...
	protected void map(LongWritable lineoffset, Text line, org.apache.hadoop.mapreduce.Mapper<LongWritable,Text,Text,Text>.Context context) throws java.io.IOException ,InterruptedException {
		...
		if(!(words[0].equalsIgnoreCase("id")))
				context.write(new Text(words[12]),new Text(rating.toString())) ;
